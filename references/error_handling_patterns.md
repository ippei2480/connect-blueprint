...
- [基本原則](#基本原則)
- [ErrorType 一覧](#errortype-一覧)
- [パターン1: リトライ付きIVRメニュー](#パターン1-リトライ付きivrメニュー)
- [パターン2: Lambda エラー時のフォールバック](#パターン2-lambda-エラー時のフォールバック)
- [パターン3: キュー満杯時のフォールバック](#パターン3-キュー満杯時のフォールバック)
- [パターン4: 営業時間チェックエラー時のデフォルト動作](#パターン4-営業時間チェックエラー時のデフォルト動作)
- [アンチパターン](#アンチパターン)
